...
class CNN(nn.Module):
    ...
    def __init__(self, channel_in=1, channel_out=1, dropout=0.0,
        ...
        l = (l - filter_size + 1)
        self.conv2 = nn.Sequential(  nn.Conv2d( in_channels=16 * channel_in,
                                                out_channels=16 * channel_in,
                                                kernel_size=(filter_size, 3),
                                                stride=(1, 1),
                                                padding=(0, 1),
        ...
        self.conv3 = nn.Sequential(  nn.Conv2d( in_channels=16 * channel_in,
                                                out_channels=16 * channel_in,
                                                kernel_size=(filter_size, 3),
                                                stride=(1, 1),
                                                padding=(0, 1),
        ...
        self.fc = nn.Sequential( nn.Linear( l * 32 * channel_in, 256, bias=True) ,
                                 nn.Dropout(dropout),     
