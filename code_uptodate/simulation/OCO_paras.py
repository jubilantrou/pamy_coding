...
def get_paras():
    ...
    parser.add_argument('--obj', default='real', type=str, choices=['sim','real'], help='train the simulator or the real robot')
    ...
    parser.add_argument('--h_l', default=50, type=int, help='the extended time points length in the past direction when constructing the training input data')
    parser.add_argument('--h_r', default=100, type=int, help='the extended time points length in the future direction when constructing the training input data')
    ...
    parser.add_argument('--lr_list', nargs=3, default=[10.0, 5.0, 5.0], type=float, help='learning rates')
    parser.add_argument('--alpha_list', nargs=3, default=[0.0001, 0.0001, 0.0001], type=float, help='one of the hyperparameters for the Newton method')
    parser.add_argument('--epsilon_list', nargs=3, default=[0.05, 0.05, 0.05], type=float, help='one of the hyperparameters for the Newton method')
    ...
    parser.add_argument('--save_path_num', default=14603, type=int, help='indicate the sequence number of the file where we restore results')
    parser.add_argument('--message', default='try multiple trajectories with more dense inputs and smaller hidden size', type=str, help='briefly record the purpose of this experiment')
    ...
    parser.add_argument('--pamy_system', default='SISO', type=str, choices=['SISO','MIMO'], help='how to treat different DoFs of the real robot')
