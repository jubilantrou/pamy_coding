...
def get_paras():
    ...
    parser.add_argument('--lr_list', nargs=3, default=[10, 5, 5], type=float, help='learning rates')
    ...
    parser.add_argument('--save_path_num', default=5031, type=int, help='indicate the sequence number of the file where we restore the results')
    parser.add_argument('--message', default='FCN+NM for comparison', type=str, help='briefly record the purpose of this experiment')
