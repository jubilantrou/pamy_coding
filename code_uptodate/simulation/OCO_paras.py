...
def get_paras():
    ...
    parser.add_argument('--h_l', default=20, type=int, help='the extended time points length in the past direction when constructing the training input data')
    parser.add_argument('--h_r', default=20, type=int, help='the extended time points length in the future direction when constructing the training input data')
    parser.add_argument('--ds', default=4, type=int, help='the stride for downsampling when constructing the training input data')
    ...
    parser.add_argument('--lr_list', nargs=3, default=[1.0, 10.0, 0.5], type=float, help='learning rates')
    ...
    parser.add_argument('--flag_dof', nargs=3, default=[False, False, True], type=bool, help='whether to include each dof in the training considering an error in the simulator')
    ...
    parser.add_argument('--save_path_num', default=7, type=int, help='indicate the sequence number of the file where we restore results')
