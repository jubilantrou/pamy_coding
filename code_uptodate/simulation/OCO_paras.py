...
def get_paras():
    ...
    parser.add_argument('--h_l', default=60, type=int, help='the extended time points length in the past direction when constructing the training input data')
    parser.add_argument('--h_r', default=60, type=int, help='the extended time points length in the future direction when constructing the training input data')
    ...
    parser.add_argument('--pamy_system', default='MIMO', type=str, choices=['SISO','MIMO'], help='how to treat different DoFs of the real robot')
