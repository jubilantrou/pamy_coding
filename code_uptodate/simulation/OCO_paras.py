...
def get_paras():
    ...
    parser.add_argument('--lr_list', nargs=3, default=[8, 5, 5], type=float, help='learning rates')
    ...
    parser.add_argument('--save_path_num', default=4291, type=int, help='indicate the sequence number of the file where we restore the results')
    parser.add_argument('--message', default='FCN + NM + vel-loss', type=str, help='briefly record the purpose of this experiment')
    parser.add_argument('--seed', default=3154, type=int, help='choose the seed for the reproducibility')
    parser.add_argument('--check_paras', action='store_true', help='remind the user to check the setting of parameters again before running the experiment')
    parser.add_argument('--ff_model', default='/home/mtian/Desktop/MPI-intern/training_log_temp_428/linear_model_ff/300/', type=str, help='whether to use pretrained policy blocks as a start')
